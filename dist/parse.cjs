...
function main() {
  return __async(this, null, function* () {
    ...
    const test_file_name = import_path.default.basename(test_file, import_path.default.extname(test_file));
    const test_output_path = import_path.default.join(test_file_path, test_file_name);
    const story = yield src_default(import_fs.default.readFileSync(test_file, "utf-8"));
